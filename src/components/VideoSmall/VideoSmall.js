...
const VideoSmall = (props) => {
   ...
   const handleclickRedirect = () =>{history.push(props.el.link)
   }

  
        return (
            <div  onClick={handleclickRedirect} className={`videoSmall "videoSmall__channelView"}`}>
               <div className="videoSmall__left">
                <img 
                src={props.el.img}
                alt={"thumbnail"} 
                className={`videoSmall__thumbnail "VideoSmall__channelView__img"}`} />
