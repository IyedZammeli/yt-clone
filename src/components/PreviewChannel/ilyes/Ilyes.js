          ...
          <div className="channel__details"></div>
            <div className="channel__detailsWrap">
                <div className="channel__avatarWrap">
                    <Avatar className="channel__avatar" src="https://scontent.fnbe1-2.fna.fbcdn.net/v/t1.15752-9/263612153_449252463445944_7594961914525054500_n.png?_nc_cat=105&ccb=1-5&_nc_sid=ae9488&_nc_ohc=NMWzwXl3cu0AX9j6KBZ&_nc_ht=scontent.fnbe1-2.fna&oh=253219ddb607c01a7fddce77d9421f4f&oe=61D1292F" />

                    <div id="videothumb__channel">

                  <h1 className="videothumb__title">Ilyes</h1>
