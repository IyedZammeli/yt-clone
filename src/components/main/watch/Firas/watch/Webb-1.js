        ...
        return (
                ...
                <div className="watch__wrap">
                    <div className="watch__left">
                        ...
                        <div className="watch__leftBtm" >
                            <h1  className="watch__title">My First web site using html5/CSS3/JS/PHP</h1>
            ...
            <div className="watch__details">
              ...
              <div className="watch__description">
                <p>the 1st web project of the 2nd year of university of web module i used HTML5 CSS3 JavaScript PHP and here m showing u all the navigation and the bd all modification
</p>
