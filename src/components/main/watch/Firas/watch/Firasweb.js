...
import o from '../Firasweb.mp4';


export default function Firasweb(){
        ...
        return (
                ...
                <div className="watch__wrap">
                    <div className="watch__left">
                        ...
                        <div className="watch__leftBtm" >
                            <h1  className="watch__title">WEB project with firas</h1>
            ...
            <div className="watch__details">
               <div className="watch__detailsContainer">
                 ...
                 <div className="video__details watch__avatarwrap">
                      ...
                      />
                       ...
                       <h1 className="video__title"> Firas Melki </h1>

                       <p  className="video__text watch__subCount"> ************************************ </p>
              ...
              <div className="watch__description">
                <p>this is my web project for last year
</p>
