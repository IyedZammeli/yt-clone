...
import o from '../ous2.m4v';


export default function Ous2(){
        ...
        return (
                ...
                <div className="watch__wrap">
                    <div className="watch__left">
                        ...
                        <div className="watch__leftBtm" >
                            <h1  className="watch__title">A simple teasing for a company</h1>
            ...
            <div className="watch__details">
              ...
              <div className="watch__description">
                <p>here the teasing for a company using AfterEffects and daVinci resolve to presents all services
</p>
