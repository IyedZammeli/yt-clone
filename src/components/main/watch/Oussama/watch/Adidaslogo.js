        ...
        return (
                ...
                <div className="watch__wrap">
                    <div className="watch__left">
                        ...
                        <div className="watch__leftBtm" >
                            <h1  className="watch__title">Adidas logo
</h1>
            ...
            <div className="watch__details">
              ...
              <div className="watch__description">
                <p>I will show you how to design the world most famous brand adidas company logo. that had been changed alot of times ! hope you guys enjoy it
</p>
