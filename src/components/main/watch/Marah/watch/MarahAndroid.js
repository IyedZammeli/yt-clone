...
import o from '../Marah-2.m4v';


export default function MarahAndroid(){
        ...
        return (
                ...
                <div className="watch__wrap">
                    <div className="watch__left">
                        ...
                        <div className="watch__leftBtm" >
                            <h1  className="watch__title">Android App Demo</h1>
            ...
            <div className="watch__details">
              ...
              <div className="watch__description">
                <p>Dewini est une application qui gère le parcours de soin pour les médecins et les patients.
                Dewini est une application mobile ayant pour objectif l'automatisation du processus sanitaire en Tunisie et garantir le confort pour les patients ainsi qu'aux docteurs.
                </p>
